...
One of the trickier areas of sustainability is how vast a category it is. A lot of people, myself previously included, think mostly about the classic triangle: reduce, reuse, recycle. And that’s a big facet of sustainability, especially ideologically.
...
- **Waste management**, especially for trash, landfill, recycling, and compost.
  - **Recycling processes** mainly involving aluminum, plastic, and paper products, and the collection and preparation of said materials.
- **Energy use**, specifically in terms of residential, commercial, and government properties, but including sources of energy, grid usage, and storage.
- **Climate change**, especially the effects on weather, moisture, heat, and ecosystem.
- **Transportation**, notably including public transit, electric vehicles, ride-sharing, personal commutes, and commercial use.
- **Education**, which ideally teaches the public how to be more sustainable in their everyday lives, and addresses common questions which, hey, is this post!

## So Then, What is Sustainability?

It’s surprisingly hard to tell what’s sustainable and what isn’t. Is it recycling? Water fountains? Using less material in packaging or refusing to offer straws unless specifically asked?
...
The idea behind zero waste isn’t just about recycling everything. Instead, it focuses on the first two R’s of the recycling poster: reduce and reuse. Zero Waste relies on recycling at the end of the chain, but starts instead with initiatives to reduce the amount of waste created in the first place, and alternative ways to repurpose and reuse old items before they become waste.

Then, when the waste being generated has been minimized as much as possible, we get into collection and diversion.
...
The City and County of Broomfield, for example, has a [Zero Waste action plan](https://www.broomfield.org/3402/Zero-Waste) intending to reduce diversion rates by 80% when all policies are enacted, up to 100% in 2035 (which is a hugely ambitious figure).

### Waste Emissions

The concept of “waste” goes much further than just trash cans. It includes a variety of concepts, origin points, and downstream effects.

For example, the trash we throw out creates landfills. Then, those same landfills create methane and other greenhouse gases as the materials in them slowly decompose.

Plastic pollution is generated when it’s created at the factory, but also pollutes streams, rivers, oceans, and other ecosystems when discarded irresponsibly, and single-use plastics can be difficult to recycle.

Waste is, by vast majority, created by commercial use, followed by single-family homes.* By comparison, multi-family dwellings produce the least waste. The prominent type of waste is municipal solid waste, followed by recycling, with organics making up a small sliver of local waste.

Because of these factors and more, tracking waste emissions is an important part of local government, and is a great metric to keep in mind when trying to become more sustainable because it’s so tangible. Waste is a physical byproduct. We can keep track of it better, and we can notice the ways in our own lives we’ve succeeded in reducing our footprint by how much less waste we can create.

**These values are relative to the City and County of Broomfield, and are based on local waste emissions tracking since 2020, but are consistent with findings in other regions.*

### Recycling & Why it Sometimes Feels Broken
...
This comes in many forms, but take the City and County of Broomfield (CCOB), for example. When the city makes decisions, it has a much larger impact. Working to make the municipal buildings produce net zero emissions has a huge impact. Helping residents upgrade their heating and cooling systems to include a heat pump stands to save a great deal of energy. Both of these happen because they’re at scale.

As a retailer, I’m frustrated by understanding that a lot of factors are out of my hands. I can’t control how my distributors pack products when they ship them to me, and often that’s a huge contributor to the waste I create. I can’t control what materials a manufacturer uses to print a game, either, although the GAMA Sustainability Committee is trying, and the [EU is working towards a circular economy of reuse.](https://go.ipoint-systems.com/blog/the-green-deal-and-the-circular-economy)

It can feel overwhelming and difficult to know where to start. I know I’ve felt that way several times as I’ve gotten more involved in tackling sustainability issues.

I do want to take a second to acknowledge the silver lining, though, because while the impacts of recycling are based on widespread adoption, when it goes well and gets public buy-in there's huge potential to make a difference.

Take [this Hank Green video comparing the Blue Origin rocket explosion to the aluminum industry](https://youtu.be/pXVmkurTOgM?si=nVXo8T8PVV1fEqjL) and how much energy is saved with recycled aluminum, for example. Individually, recycling the can my sparkling water came in doesn’t do much. But when all of America is doing it (or closer to 40% based on the data mentioned in the video), it amounts to saving pollution equivalent to 15 rocket explosions per day.
...
In putting together this post, I did a lot of research both within my industry and community, and also about sustainability in general.
...
- [“A Rocket Exploded. We Need to do Math.” by Hank Green](https://youtu.be/pXVmkurTOgM?si=nVXo8T8PVV1fEqjL) - a YouTube video detailing the waste produced by the Blue Origin rocket explosion compared to what’s conserved through recycling, especially in the manufacturing of aluminum.
- *[Circular Economy Action Plan: How the EU Green Deal Is Transforming Europe’s Economy](https://go.ipoint-systems.com/blog/the-green-deal-and-the-circular-economy)* - a deep dive into the new Circular Economy Action Plan implemented in the EU and how it affects sustainability.
- *[Clean Industrial Deal](https://commission.europa.eu/topics/competitiveness/clean-industrial-deal_en)* - a writeup by the European Commission detailing the new Clean Industrial Deal, designed to make energy more affordable while simultaneously boosting adoption of green energy alternatives.
